...
```javascript
// Localhost
const apiURL = 'https://localhost/RHC-Protocol-Core/PoC/level_1_basic/api/';

// Dominio local (Laragon)
const apiURL = 'https://www.rhc-protocol-core.test/PoC/level_1_basic/api/';
```
...
```
https://localhost/RHC-Protocol-Core/PoC/level_1_basic/public_html/
```

o con dominio local:

```
https://www.rhc-protocol-core.test/PoC/level_1_basic/public_html/
```
...
```javascript
// Localhost
const apiURL = 'https://localhost/RHC-Protocol-Core/PoC/level_2_intermediate/api/';

// Dominio local
const apiURL = 'https://www.rhc-protocol-core.test/PoC/level_2_intermediate/api/';
```
...
```javascript
// Localhost
const apiURL = 'https://localhost/RHC-Protocol-Core/PoC/level_3_advanced/api/';

// Dominio local
const apiURL = 'https://www.rhc-protocol-core.test/PoC/level_3_advanced/api/';
```
...
```javascript
// Localhost
const apiURL = 'https://localhost/RHC-Protocol-Core/PoC/level_4_dynamic_adaptive/api/';

// Dominio local
const apiURL = 'https://www.rhc-protocol-core.test/PoC/level_4_dynamic_adaptive/api/';
```
